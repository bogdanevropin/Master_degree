# FILE: duxalp.tcl
#
# Configuration feature definitions for the configuration 'duxalp'
#
...
if {[string match cxx $ccbasename]} {
    # ...for DU's compiler cxx 
...
# Linker selection and options...
set lbasename [file tail [lindex [$config GetValue program_compiler_c++] 0]]
if {[string match cxx $lbasename]} {
    # ...for DU's cxx as linker
    $config SetValue program_linker [list $lbasename -ptr duxalp/tr]
