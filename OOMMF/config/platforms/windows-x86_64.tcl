...
# CUDA
#
set cuda_compiler {nvcc -c -m 64 -w --cudart static -Xcompiler \
 "/openmp /nologo /Zi /DNDEBUG /Ox /fp:fast /D_CRT_SECURE_NO_DEPRECATE"}
...
if {[Oc_Option Get Threads oommf_thread_count _] && \
   ...
   # Value not set in Oc_Options or platforms/local/windows-x86_64.tcl,
   # so query the system:
