...
proc ConfirmExitAll {} {
	...
	Oc_EventHandler New _ Net_Thread Ready [list %object Send exit]
	# Keep event loop running while threads go away.
	if {[llength [Net_Thread Instances]]} {
	    Oc_EventHandler New _ Net_Thread Delete CheckLastThread
