...
proc AsyncTempFileDisplayRequest { fnlist } {
    ...
    Oc_Main BlockExit
    # TODO - attempt adjusting the scheduling to match display times
    after 20 DisplayLast
}
...
proc DisplayLast {} {
	...
	# Don't display when we're exiting...
	if {!$_mmdispcmds(shutdown)} {
