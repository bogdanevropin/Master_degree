...
#ifndef _UCSD_GPU_TIMEDRIVER
#define _UCSD_GPU_TIMEDRIVER
...
class UCSD_GPU_TimeDriver:public Oxs_Driver {
private:
  Oxs_OwnedPointer<UCSD_GPU_TimeEvolver> evolver_obj; // Evolver basket
  Oxs_Key<UCSD_GPU_TimeEvolver> evolver_key;
...
Oxs_ScalarOutput<UCSD_GPU_TimeDriver> name##_output
  OSO_DECL(last_timestep);
  OSO_DECL(simulation_time);
#undef OSO_DECL

  Oxs_VectorFieldOutput<UCSD_GPU_TimeDriver> spin_output;
  Oxs_VectorFieldOutput<UCSD_GPU_TimeDriver> magnetization_output;
  Oxs_ScalarOutput<UCSD_GPU_TimeDriver> aveMx_output;
  Oxs_ScalarOutput<UCSD_GPU_TimeDriver> aveMy_output;
  Oxs_ScalarOutput<UCSD_GPU_TimeDriver> aveMz_output;
  
  Oxs_ScalarOutput<UCSD_GPU_TimeDriver> maxSpinAng_output;
  Oxs_ScalarOutput<UCSD_GPU_TimeDriver> stage_maxSpinAng_output;
  Oxs_ScalarOutput<UCSD_GPU_TimeDriver> run_maxSpinAng_output;
  void Fill__maxSpinAng_output(const Oxs_SimState& state);
  void CPUComputeMaxAng(const Oxs_SimState& state, const OC_INDEX &size,
  ...
  UCSD_GPU_TimeDriver(const UCSD_GPU_TimeDriver&);
  UCSD_GPU_TimeDriver& operator=(const UCSD_GPU_TimeDriver&);

public:
  UCSD_GPU_TimeDriver(const char* name,    // Child instance id
                 Oxs_Director* newdtr, // App director
                 const char* argstr);  // MIF input block parameters
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  virtual ~UCSD_GPU_TimeDriver();
