...
{ // Computes an estimate on the minimum time needed to
  ...
  OC_REAL8m chk_timestep = DBL_MAX/64.;
  if(max_dm_dt>1 || OC_REAL8_EPSILON<chk_timestep*max_dm_dt) {
    chk_timestep = OC_REAL8_EPSILON/max_dm_dt;
    // A timestep of size chk_timestep will be hopelessly lost
