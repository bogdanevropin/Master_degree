...
protected:
  ...
  Oxs_Energy(const char* name,      // Child instance id
             ...
             OC_BOOL enable_base_outputs=1);
  /// Base outputs are default outputs provided by Oxs_Energy class.
  /// Set no_base_outputs true if you want to disable the default
  /// outputs.  This allows child classes to override the defaults.
