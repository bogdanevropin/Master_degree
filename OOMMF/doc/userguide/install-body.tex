...
third formats
are \fn{.zip} compressed archives containing source code and
...
recorded via other means\index{platform!Windows!no~Tcl~configuration~file}, so
...
\htmladdnormallinkfoot{ActiveTcl}{http://www.activestate.com/activetcl/}.
