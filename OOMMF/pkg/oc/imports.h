...
#if !defined(CONST84) && ((TCL_MAJOR_VERION > 8) || ((TCL_MAJOR_VERSION == 8) && (TCL_MINOR_VERSION > 6)))
...
__attribute__((optimize(2,"no-fast-math")))
#endif
Oc_Atan2RW(OC_REALWIDE y,OC_REALWIDE x)
{
...
__attribute__((optimize(2,"no-fast-math")))
#endif
Oc_Atan2(long double y,long double x)
{
#if OC_DOMAIN_CHECK_ATAN2
